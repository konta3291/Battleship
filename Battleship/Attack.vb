Public Class Attack
    ...
    Public Function AttackEnemyship(table As Integer()()) As Integer()()
        ...
        returnTable = TurnSquareIntoAttackedSquare(returnTable, lineNumber, columnNumber)
    ...
    ''' <returns></returns>
    Public Function TurnSquareIntoAttackedSquare(table As Integer()(), lineNumber As Integer, columnNumber As Integer) As Integer()()
        Dim returnTable As Integer()() = table
